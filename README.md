...
エンジニア歴の長い夫のサポート下で、ChatGPT（GPT-5有料プラン）を活用して独学に励んでいます。<br>
AIで情報を得つつも自分で手を動かし、理解を積み重ねる学習に努めています。
...
- ToDoリスト作成（Reactで実装）
- お問い合わせフォーム作成（Udemy講座をベースに開発 / Next.jsで環境構築 / バリデーション設計 / ServerActionで送信処理 / PrismaでDB操作）
- 簡易ブログシステム作成（Udemy講座をベースに開発 / Next.jsで環境構築 / ログイン機能 / 検索機能 / 画像UL）
...
✅ **[公開ページはこちら（Vercel）_簡易ブログシステム](https://next-udemy-blog-lyart.vercel.app)**
